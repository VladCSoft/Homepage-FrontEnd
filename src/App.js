    ...
    <div className="App">
      ...
      <div className="Information-Background">
            ...
            <div className="Career-Oil-Gas-Block">
                  ...
                  <h1 className="CIGHeader2"> Construieste-ti</h1>
                  <h1 className="CIGHeader2-2"> cariera in domeniul  </h1>
            ...
            <div className="Online-Training-Block">
                  ...
                  <h3 className="OTButton"> AFLA MAI MULTE </h3>
            </div>
      </div>
      ...
      <div className="Audio-Block"> 
            ...
            <h3 className="FeaturesHeader2"> Lorem ipsum dolor sit amet, </h3>
            <h3 className="FeaturesHeader3"> consectetur adipiscing elit.</h3>
      </div>
      ...
      <div className="Bottom-Bar-Items1"> 
            <ul className="Bottom-Navigation-Bar-Items1">
              <li className="Item-Bottom"> HOME </li>
              <li className="Item-Bottom"> DESPRE NOI </li>
              <li className="Item-Bottom"> CURSURI </li>
              <li className="Item-Bottom"> SOCIAL MEDIA </li>
            </ul>
      </div>
      <div className="Bottom-Bar-Items2">
            <ul className="Bottom-Navigation-Bar-Items2">
              <li> PLATFORMA </li>
              <li className="Item-Stiri"> STIRI </li>
              <li className="Item-Contact"> CONTACT</li>
              <li className="Facebook-Logo"> </li>
              <li className="Twitter-Logo"> </li>
              <li className="Instagram-Logo"> </li>
              <li className="Youtube-Logo"> </li> 
            </ul>
      </div>
      </div>
      </div>
